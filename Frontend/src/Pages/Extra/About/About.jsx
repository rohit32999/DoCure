...
const About = () => {
    return (
        <div className='container'>
            ...
            <p className='my-6 px-10'>DoCure is an online Hospital Managemnt System that caters to the day to day operations of the hospitals . </p>

            <p className='px-10'>DoCure offers on-demand GP and specialist consultations with verified and certified doctors, online prescriptions, medicine delivery, pathology/ diagnostics tests, all while building valuable Electronic Health Records</p>
