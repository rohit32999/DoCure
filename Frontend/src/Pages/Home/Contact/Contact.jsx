                    ...
                    <div className="-mx-4 flex flex-wrap lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="my-12 max-w-[570px] lg:mb-0">
                                ...
                                <h2 className="text-dark mb-6 text-[32px] font-bold sm:text-[40px] lg:text-[36px] xl:text-[40px]" data-aos="fade-up" data-aos-duration="800">
                                    Let's Connect!
                                </h2>
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full" data-aos="fade-left" data-aos-duration="800">
                                        ...
                                        <p className="text-body-color text-base">(+91)6290330398</p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]" data-aos="fade-right" data-aos-duration="800">
                                    <div className="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">aratrik.bandyopadhyay.21@aot.edu.in</p>
                                        <p className="text-body-color text-base">soumyajit.mondal.21@aot.edu.in</p>
                                    </div>
                                </div>
                            </div>
                        </div>
